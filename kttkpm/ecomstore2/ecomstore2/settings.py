"""
Django settings for ecomstore2 project.
...
SECRET_KEY = "django-insecure-1ttw_=x4y8b8uk6fxt%h+@lceam)*s26=n!i%l-7ks@frhnp3z"
...
WSGI_APPLICATION = "ecomstore2.wsgi.application"
